...
parseUri.options = {
  ...
  history.pushState = function(data, title, pathname) {
    fakeWindow.location.pathname = pathname;
  };

  history.replaceState = function(data, title, pathname) {
    fakeWindow.location.pathname = pathname;
  };
  ...
  fakeWindow.addEventListener = function() {
    window.addEventListener.apply(fakeWindow, arguments);
  };
  fakeWindow.removeEventListener = function() {
    window.removeEventListener.apply(fakeWindow, arguments);
  };
  fakeWindow.setInterval = function() {
    // window.setInterval(arguments);
  };
  fakeWindow.clearInterval = function() {
    // window.clearInterval(arguments);
  };
